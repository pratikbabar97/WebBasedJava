...
//
	...
	public ResponseEntity<?> deleteCategory(@PathVariable Long id) {
		...
		return ResponseEntity.ok(categoryService.deleteCategoryDetails(id));
	}

	@GetMapping("/{desc}")
	public ResponseEntity<?> findByDescriptionContaining(@PathVariable String desc) {
		return ResponseEntity.status(HttpStatus.OK).body(categoryService.findByDec(desc));
	}
