...
//		return new ApiResponse(msg);
		Products product1 = productRepository.findById(productId)
				.orElseThrow(() -> new ResourceNotFoundException("id not present..!!"));
...
//		list=productRepository.findByCategoryContaining(category);
//		return list;
//	}

	@Override
	public List<Products> findProductsBYCategory(Category category) {
		// TODO Auto-generated method stub
		List<Products> list= new ArrayList<Products>();
		list=productRepository.findByCategoryContaining(category);
		return list;
